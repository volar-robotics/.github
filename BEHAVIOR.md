...
- The commit body cites the observations behind the change, or the correction
  that triggered it where there are none. Why a rule exists lives in history,
  which costs the rule itself no line.
