# Volar Robotics — Standards

> One rule, one file. A rule written twice is a bug in the copy outside its home.

| File | Governs |
|---|---|
| [NAMING.md](NAMING.md) | every identifier, on every surface |
